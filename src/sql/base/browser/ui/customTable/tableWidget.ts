...
import { IDelegate, IRenderer, IListEvent, IListContextMenuEvent, IListMouseEvent, IListTouchEvent, IListGestureEvent, IListOpenEvent } from './table';
import { TableView, ITableViewOptions } from './tableView';
...
export interface IListOptions<T> extends ITableViewOptions, IListStyles {
...
export class Table<T> implements ISpliceable<T>, IDisposable {

	private static InstanceCount = 0;
	private idPrefix = `list_id_${++Table.InstanceCount}`;
	...
	constructor(
		...
		this.view = new TableView(container, delegate, renderers, options);
